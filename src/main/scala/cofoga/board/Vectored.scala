...
trait Vectored {
  ...
  def horizontal(row: Int, col: Int)(end: Int): RandomAccessSeq.Projection[Player] = end match {
  ...
  def vertical(row: Int, col: Int)(end: Int): RandomAccessSeq.Projection[Player] = end match {
    case end if end < 0 => val k = -end
  ...
  def diagonalup(row: Int, col: Int)(end: Int): RandomAccessSeq.Projection[Player] = end match {
    case end if end < 0 => val k = -end
  ...
  def diagonaldown(row: Int, col: Int)(end: Int): RandomAccessSeq.Projection[Player] = end match {
    case end if end < 0 => val k = -end
